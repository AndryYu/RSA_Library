...
import com.zyu.wsecx.asn1.ASN1Null;
...
import com.zyu.wsecx.pkcs7.encode.EnvelopedDataRSABuilder;
            ...
            if (encAlg != null) {
                ...
                if (sParams != null && !(sParams instanceof ASN1Null)) {
                    try {
                        ...
                        if (encAlg.equals(EnvelopedDataRSABuilder.DES_EDE3_CBC)
                                || encAlg.equals(EnvelopedDataRSABuilder.IDEA_CBC)
                                || encAlg.equals(EnvelopedDataRSABuilder.AES128_CBC)
                                || encAlg.equals(EnvelopedDataRSABuilder.AES192_CBC)
                                || encAlg.equals(EnvelopedDataRSABuilder.AES256_CBC)) {
                    ...
                    if (encAlg.equals(EnvelopedDataRSABuilder.DES_EDE3_CBC)
                            || encAlg.equals(EnvelopedDataRSABuilder.IDEA_CBC)
                            || encAlg.equals(EnvelopedDataRSABuilder.CAST5_CBC)) {
