...
import com.zyu.wsecx.pkcs7.encode.EnvelopedBuilder;
...
public class CMSEnvelopedHelper {
    public static final CMSEnvelopedHelper INSTANCE = new CMSEnvelopedHelper();
    ...
    static {
        KEYSIZES.put(EnvelopedBuilder.DES_EDE3_CBC, new Integer(192));
        KEYSIZES.put(EnvelopedBuilder.AES128_CBC, new Integer(128));
        KEYSIZES.put(EnvelopedBuilder.AES192_CBC, new Integer(192));
        KEYSIZES.put(EnvelopedBuilder.AES256_CBC, new Integer(256));

        BASE_CIPHER_NAMES.put(EnvelopedBuilder.DES_EDE3_CBC, "DESEDE");
        BASE_CIPHER_NAMES.put(EnvelopedBuilder.AES128_CBC, "AES");
        BASE_CIPHER_NAMES.put(EnvelopedBuilder.AES192_CBC, "AES");
        BASE_CIPHER_NAMES.put(EnvelopedBuilder.AES256_CBC, "AES");

        CIPHER_ALG_NAMES.put(EnvelopedBuilder.DES_EDE3_CBC, "DESEDE/CBC/PKCS5Padding");
        CIPHER_ALG_NAMES.put(EnvelopedBuilder.AES128_CBC, "AES/CBC/PKCS5Padding");
        CIPHER_ALG_NAMES.put(EnvelopedBuilder.AES192_CBC, "AES/CBC/PKCS5Padding");
        CIPHER_ALG_NAMES.put(EnvelopedBuilder.AES256_CBC, "AES/CBC/PKCS5Padding");

        MAC_ALG_NAMES.put(EnvelopedBuilder.DES_EDE3_CBC, "DESEDEMac");
        MAC_ALG_NAMES.put(EnvelopedBuilder.AES128_CBC, "AESMac");
        MAC_ALG_NAMES.put(EnvelopedBuilder.AES192_CBC, "AESMac");
        MAC_ALG_NAMES.put(EnvelopedBuilder.AES256_CBC, "AESMac");
    }
