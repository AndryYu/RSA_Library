...
public class Base64 {
	...
	public static String encode(byte[] data) {
		 byte[] retBy = android.util.Base64.encode(data,
		 android.util.Base64.NO_WRAP);
		
		 if (retBy != null) {
		 return new String(retBy);
		 }
		 return null;
	}
	...
	public static byte[] decode(byte[] data) {
		 ...
		 byte[] retBy = android.util.Base64.decode(data,
		 android.util.Base64.NO_WRAP);
	...
	public static byte[] decode(String data) {
		...
		byte[] retBy = android.util.Base64.decode(data, android.util.Base64.NO_WRAP);
