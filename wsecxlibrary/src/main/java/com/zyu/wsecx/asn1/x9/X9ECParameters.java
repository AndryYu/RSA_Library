...
public class X9ECParameters extends ASN1Encodable implements X9ObjectIdentifiers {
	...
	public X9ECParameters(ASN1Sequence seq) {
		...
		X9Curve x9c = new X9Curve(new X9FieldID((ASN1Sequence) seq
				.getObjectAt(1)), (ASN1Sequence) seq.getObjectAt(2));

		this.curve = x9c.getCurve();
		this.g = new X9ECPoint(curve, (ASN1OctetString) seq.getObjectAt(3))
				.getPoint();
