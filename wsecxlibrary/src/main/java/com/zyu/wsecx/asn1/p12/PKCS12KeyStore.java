package com.zyu.wsecx.asn1.p12;
...
import com.zyu.wsecx.asn1.BEROutputStream;
import com.zyu.wsecx.asn1.DERBMPString;
...
import com.zyu.wsecx.asn1.pkcs.AuthenticatedSafe;
import com.zyu.wsecx.asn1.pkcs.CertBag;
import com.zyu.wsecx.asn1.pkcs.ContentInfo;
import com.zyu.wsecx.asn1.pkcs.MacData;
import com.zyu.wsecx.asn1.pkcs.PKCS12PBEParams;
import com.zyu.wsecx.asn1.pkcs.PKCSObjectIdentifiers;
import com.zyu.wsecx.asn1.pkcs.Pfx;
import com.zyu.wsecx.asn1.pkcs.PrivateKeyInfo;
import com.zyu.wsecx.asn1.pkcs.SafeBag;
import com.zyu.wsecx.asn1.x509.AlgorithmIdentifier;
import com.zyu.wsecx.asn1.x509.AuthorityKeyIdentifier;
import com.zyu.wsecx.asn1.x509.DigestInfo;
import com.zyu.wsecx.asn1.x509.SubjectKeyIdentifier;
import com.zyu.wsecx.asn1.x509.SubjectPublicKeyInfo;
import com.zyu.wsecx.asn1.x509.X509Extensions;
import com.zyu.wsecx.asn1.x509.X509ObjectIdentifiers;
...
public class PKCS12KeyStore extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    public PKCS12KeyStore(String provider, DERObjectIdentifier keyAlgorithm, DERObjectIdentifier certAlgorithm) {
...
//					System.out.println("extra " + ASN1Dump.dumpAsString(c[i].getContent()));
            ...
            try {
                ...
                if (cert instanceof PKCS12BagAttributeCarrier) {
                    ...
                    while (e.hasMoreElements()) {
                        ...
                        // require
                        // a localKeyID and will confuse some PKCS12
                        // implementations.
                        //
    ...
    private static byte[] calculatePbeMac(DERObjectIdentifier oid, byte[] salt, int itCount, char[] password, boolean wrongPkcs12Zero, byte[] data) throws Exception {
        ...
        Mac mac = Mac.getInstance(oid.getId());
        mac.init(key, defParams);
        mac.update(data);
        return mac.doFinal();
    }

    public static class WPKCS12KeyStore extends PKCS12KeyStore {
        public WPKCS12KeyStore() {
            super(null, pbeWithSHAAnd3_KeyTripleDES_CBC, pbewithSHAAnd40BitRC2_CBC);
        }
    }

    public static class WPKCS12KeyStore3DES extends PKCS12KeyStore {
        public WPKCS12KeyStore3DES() {
            super(null, pbeWithSHAAnd3_KeyTripleDES_CBC, pbeWithSHAAnd3_KeyTripleDES_CBC);
        }
    }

    public static class DefPKCS12KeyStore extends PKCS12KeyStore {
        public DefPKCS12KeyStore() {
            super(null, pbeWithSHAAnd3_KeyTripleDES_CBC, pbewithSHAAnd40BitRC2_CBC);
        }
    }

    public static class DefPKCS12KeyStore3DES extends PKCS12KeyStore {
