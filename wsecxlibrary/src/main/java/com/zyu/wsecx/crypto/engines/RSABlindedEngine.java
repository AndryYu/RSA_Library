package com.zyu.wsecx.crypto.engines;

import com.zyu.wsecx.crypto.AsymmetricBlockCipher;
import com.zyu.wsecx.crypto.Digest;
import com.zyu.wsecx.crypto.params.ECPrivateKeyParameters;
import com.zyu.wsecx.crypto.params.ECPublicKeyParameters;
import com.zyu.wsecx.crypto.params.ParametersWithRandom;
import com.zyu.wsecx.crypto.params.RSAKeyParameters;
...
public class RSABlindedEngine implements AsymmetricBlockCipher {
	...
	public byte[] processBlock(byte[] in, int inOff, int inLen) {
		...
		if (key instanceof RSAPrivateCrtKeyParameters) {
			...
			if (k.getPublicExponent() != null) // can't do blinding without a
												// public exponent
			{
